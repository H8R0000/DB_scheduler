...
class Student(QDialog):
   ...
   def push_student(self):
      ...
      myTable.insert("name", "surname", "patronymic", "st", "alive", "id_group", "spec", "group_name").values(self.name, self.surname, self.patr, self.st, self.alive, self.id_group, self.spec, self.group_name).execute()
      print(info_student)
